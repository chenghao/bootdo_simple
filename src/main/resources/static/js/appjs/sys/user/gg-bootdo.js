...
$(function(){
	...
	//////////////////////////////////
	$(".pwdOld").on('mouseover',function(){
		$('#pwdOld').prop('type', 'text');
	});
	$(".pwdOld").on('mouseout',function(){
		$('#pwdOld').prop('type', 'password');
	});

	$(".pwdNew").on('mouseover',function(){
		$('#pwdNew').prop('type', 'text');
	});
	$(".pwdNew").on('mouseout',function(){
		$('#pwdNew').prop('type', 'password');
	});

	$(".rePwdNew").on('mouseover',function(){
		$('#confirm_password').prop('type', 'text');
	});
	$(".rePwdNew").on('mouseout',function(){
