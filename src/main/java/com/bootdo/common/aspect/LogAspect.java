...
public class LogAspect {
    ...
    void saveLog(ProceedingJoinPoint joinPoint, long time) {
        ...
        List<Object> needLists = new ArrayList<>();
        for(Object obj : args){
            boolean bo1 = obj instanceof Model;
            boolean bo2 = obj instanceof ModelMap;
            boolean bo3 = obj instanceof HttpServletRequest;
            boolean bo4 = obj instanceof HttpServletResponse;

            if(!bo1 && !bo2 && !bo3 && !bo4){
                needLists.add(obj);
            }
        }
        sysLog.setParams(JSON.toJSONString(needLists));
        // 获取request
